...
var HttpServer = function(j_val) {
  ...
  this.requestStream = function() {
    var __args = arguments;
    if (__args.length === 0) {
      return utils.convReturnVertxGen(j_httpServer["requestStream()"](), HttpServerRequestStream);
    } else utils.invalidArgs();
  };
  ...
  this.requestHandler = function(handler) {
    ...
    if (__args.length === 1 && typeof __args[0] === 'function') {
      return utils.convReturnVertxGen(j_httpServer["requestHandler(io.vertx.core.Handler)"](function(jVal) {
  ...
  this.websocketStream = function() {
    var __args = arguments;
    if (__args.length === 0) {
      return utils.convReturnVertxGen(j_httpServer["websocketStream()"](), ServerWebSocketStream);
    } else utils.invalidArgs();
  };
  ...
  this.websocketHandler = function(handler) {
    var __args = arguments;
    if (__args.length === 1 && typeof __args[0] === 'function') {
      return utils.convReturnVertxGen(j_httpServer["websocketHandler(io.vertx.core.Handler)"](function(jVal) {
